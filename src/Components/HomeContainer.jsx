  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        <div className="flex items-center gap-2 justify-center bg-pink-100 px-4 py-1 rounded-full">
        ...
        <p className="text-[2rem] lg:text-[4.5rem] font-bold tracking-wide text-headingColor">
          Welcome to the&nbsp; 
          <span className="text-pink-600 text-[3rem] lg:text-[5rem]">
            Food World!
          </span>
        </p>

        <p className="text-base text-pink-900 text-center md:text-left md:w-[80%]">
            ...
            heroData.map((n) => (
              ...
              >
                ...
                <p className="text-sm font-semibold text-headingColor">
                  <span className="text-xs text-rose-600">₹</span> {n.price}
                </p>
              </div>
            ))}
        </div>
